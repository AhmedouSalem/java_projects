...
<body>
	...
	<div class="container sp mt-4">
		...
		<button type="button" class="btn btn-success mb-2" data-toggle="modal"
			data-target="#addCategorieModal">Ajouter une catégorie</button>
						...
						<td>
							...
							<form action="./categories" method="post" style="display: inline;">
								<input type="hidden" name="categorieId"
									value="${categorie.categorieId}"> <input type="hidden"
							...
							<button type="button" class="btn btn-primary btn-sm"
								data-toggle="modal" data-target="#editCategorieModal"
								onclick="setEditModalValues('${categorie.categorieId}', '${categorie.categorieName}')">
