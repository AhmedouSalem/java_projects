...
<body>
			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						...
						<form method="post" action="./loginAdmin" class="register-form"
							id="login-form">
							...
							<div class="form-group">
								<input type="checkbox" name="remember-me" id="remember-me"
									...
									class="label-agree-term"><span><span></span></span>Se
    ...
    if (status === "failed") {
        showSnackbar("V�rifiez votre nom d'utilisateur ou mot de passe", true);
    } else if (status === "success") {
        showSnackbar("Connexion r�ussie", false);
    }
</script>
