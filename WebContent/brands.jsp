...
<body>
	...
	<div class="container sp mt-4">
		...
		<button type="button" class="btn btn-success mb-2" data-toggle="modal"
			data-target="#addBrandModal">Ajouter une marque</button>
					...
					<tr>
						...
						<td>
							...
							<button type="button" class="btn btn-primary btn-sm"
								...
								onclick="setEditModalValues('${brand.brandId}', '${brand.brandName}')">
				...
				<div class="modal-body">
					<form id="addBrandForm" action="./brands" method="post">
						...
						<div class="form-group">
							<label for="brandName">Nom de la marque:</label> <input
				...
				<div class="modal-body">
					<form id="editBrandForm" action="./brands" method="post">
						<input type="hidden" name="action" value="edit"> <input
							type="hidden" id="editBrandId" name="brandId">
						<div class="form-group">
							<label for="editBrandName">Nom de la marque:</label> <input
